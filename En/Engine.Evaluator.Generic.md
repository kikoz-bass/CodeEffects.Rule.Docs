...
Provides core functionality for [evaluating](/decision-automation/business-rule-evaluation) business rules when the exact type of the [source object](/decision-automation/business-rule-source-object) is known at design time.
...
- ### Evaluator(..)
	...
	- *rulesetXml* (`System.String`) - The [Rule XML](/decision-automation/business-rules-storage) document as a string.
	- *getRule* ([`CodeEffects.Rule.Common.Models.GetRuleDelegate`](/decision-automation/rule-common-models-getruledelegate)) - The delegate used to retrieve a rule by its ID when the ruleset being [evaluated](/decision-automation/business-rule-evaluation) references other rules. The default value is `null`.
